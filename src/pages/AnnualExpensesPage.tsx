                ...
                {detectedPatterns.map((pattern) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="w-full mt-3 py-2 bg-ink-black dark:bg-pig-pink text-paper-white rounded-md text-sub"
                    >
                      알림 추가
                    </button>
                  </div>
        ...
        {patterns.length === 0 ? (
          <div className="py-12 text-center">
            ...
            <button
              onClick={handleScan}
              disabled={isScanning}
              className="px-6 py-3 bg-ink-black dark:bg-pig-pink text-paper-white rounded-md text-body"
            >
